...
const STACK_NODE_TEMPLATE: Array<WorkflowNodeMeta & { id: string; x: number; y: number }> = [
  { id: "stack-1", nodeType: "github", label: "GitHub", icon: "source", category: "Developer Stage", status: "idle", x: 40, y: 320 },
  { id: "stack-2", nodeType: "gh-actions", label: "GitHub Actions", icon: "ci", category: "CI Pipeline", status: "idle", x: 280, y: 320 },
  { id: "stack-3", nodeType: "docker", label: "Docker", icon: "registry", category: "Container Registry", status: "idle", x: 520, y: 320 },
  { id: "stack-4", nodeType: "dockerhub", label: "Docker Hub", icon: "registry", category: "Container Registry", status: "idle", x: 760, y: 320 },
  { id: "stack-5", nodeType: "trivy", label: "Trivy", icon: "container-sec", category: "Container Security", status: "idle", x: 1000, y: 320 },
  { id: "stack-6", nodeType: "kubernetes", label: "Kubernetes", icon: "k8s", category: "Kubernetes Runtime", status: "idle", x: 1240, y: 320 },
  { id: "stack-7", nodeType: "argocd", label: "ArgoCD", icon: "deploy", category: "CD Deployment", status: "idle", x: 1480, y: 320 },
  { id: "stack-8", nodeType: "prometheus", label: "Prometheus", icon: "monitoring", category: "Monitoring", status: "idle", x: 1720, y: 240 },
  { id: "stack-9", nodeType: "grafana", label: "Grafana", icon: "monitoring", category: "Monitoring", status: "idle", x: 1720, y: 400 },
  { id: "stack-10", nodeType: "loki", label: "Loki", icon: "logging", category: "Logging", status: "idle", x: 1960, y: 320 },
  { id: "stack-11", nodeType: "vault", label: "Vault", icon: "secrets", category: "Secrets & Config", status: "idle", x: 2200, y: 240 },
  { id: "stack-12", nodeType: "terraform", label: "Terraform", icon: "iac", category: "Infrastructure as Code", status: "idle", x: 2200, y: 400 },
  { id: "stack-13", nodeType: "k6", label: "k6", icon: "testing", category: "Testing", status: "idle", x: 2440, y: 320 },
];
